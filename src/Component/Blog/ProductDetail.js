...
function ProductDetail(){
    ...
    function renderImage(){
        for(let i = 1 ; i <= 3 ; i++){
            ...
            if(i === 1){
                divClass += "active"
                return   <div className={divClass} key={i}>
                            {renderImage2()}
                        </div>
            }
        }
    ...
    function renderImage2(){
        if(Object.keys(getData).length > 0){
            ...
            return image.map((value, key)=> {
                // console.log(value);
                return  <a  href><img width="30%" onClick={renderClick} src={"http://localhost/laravel8/laravel8/public/upload/product/"+ getData.id_user + "/" + value} alt="" /></a>
            })
    ...
    function renderImagemax(){
        if(getImage.length > 0 ){
            return <img src={"http://localhost/laravel8/laravel8/public/upload/product/"+ getData.id_user + "/" + getImage} alt="" />
        }
    ...
    function renderData(){
        if(Object.keys(getData).length > 0){
           let image = JSON.parse(getData.image)
                ...
                return      <div className="product-details">{/*product-details*/}
                                <div className="col-sm-5">
                                    <div className="view-product">
                                            {renderImagemax()}
                                            <a href={"http://localhost/laravel8/laravel8/public/upload/product/"+ getData.id_user + "/" + image[0]} rel="prettyPhoto"><h3>ZOOM</h3></a>
                                    </div>
